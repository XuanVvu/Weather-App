...
const Today = () => {
                        ...
                        <Col lg="4" className="p-3">
                            <div className="today__item p-2 h-100">
                                ...
                                <div className="UV__item__content text-center">
                                    ...
                                    <p className="fs-3 fw-bold text-muted">0</p>
                                </div>
                            </div>
                        </Col>
	...
	z"
                                    ...
                                    <p className="fs-3 fw-bold text-muted">
                                        {(currentWeather.wind.speed * 3.6).toFixed(2)} km/h
                                    </p>
                                </div>
                            </div>
                        </Col>
	...
	"
                                    ...
                                    <p className="fs-3 fw-bold text-muted">{currentWeather.main.humidity} %</p>
                                </div>
                            </div>
                        </Col>
                        ...
                        <Col lg="4" className="p-3">
                            <div className="today__item p-2">
                                ...
                                <div className="UV__item__content text-center">
                                    ...
                                    <p className="fs-3 fw-bold text-muted">{currentWeather.visibility / 1000} km</p>
                                </div>
                            </div>
                        </Col>
                        ...
                        <Col lg="4" className="p-3">
                            <div className="today__item p-2">
                                ...
                                <div className="UV__item__content text-center">
                                    ...
                                    <p className="fs-3 fw-bold text-muted">
                                        {currentWeather.main.sea_level || currentWeather.main.pressure} hPa
                                    </p>
                                </div>
                            </div>
                        </Col>
